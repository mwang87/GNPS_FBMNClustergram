...
DASHBOARD = [
    dbc.CardHeader(html.H5("GNPS FBMN Clustergram Dashboard")),
    dbc.CardBody(
        [   
...
def update_clustergram(gnps_task):
    ...
    filename_headers = [header for header in quant_df.columns if "Peak area" in header]
